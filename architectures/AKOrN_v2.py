# new random vector for each layer; readout is one relu layer; matrices in Kuramoto layers are not constrained
...
class AKOrN_v2_classification(AKOrN_v2):
